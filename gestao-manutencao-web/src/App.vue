<script setup>
    ...
    async function buscarClientes() {
        try {
            const resposta = await fetch('https://api-gestao-manutencao-ecedhmdaffe7ere7.brazilsouth-01.azurewebsites.net/api/Cliente');
	...
	async function salvarCliente() {
		try {
			...
			const urlDaApi = isEdicao
				? `https://api-gestao-manutencao-ecedhmdaffe7ere7.brazilsouth-01.azurewebsites.net/api/Cliente/${pacoteCliente.id}`
				: 'https://api-gestao-manutencao-ecedhmdaffe7ere7.brazilsouth-01.azurewebsites.net/api/Cliente';
	...
	async function deletarCliente(id, nome) {
		if (confirm(`Atenção: Deseja realmente excluir o cliente ${nome}?`)) {
			try {
				const resposta = await fetch(`https://api-gestao-manutencao-ecedhmdaffe7ere7.brazilsouth-01.azurewebsites.net/api/Cliente/${id}`, {
					method: 'DELETE'
				});
    ...
    async function buscarOrdensDeServico() {
        try {
            const resposta = await fetch('https://api-gestao-manutencao-ecedhmdaffe7ere7.brazilsouth-01.azurewebsites.net/api/OrdemDeServico');
    ...
    async function salvarOS() {
        try {
            ...
            const urlDaApi = isEdicao
                ? `https://api-gestao-manutencao-ecedhmdaffe7ere7.brazilsouth-01.azurewebsites.net/api/OrdemDeServico/${pacoteOS.id}`
                : 'https://api-gestao-manutencao-ecedhmdaffe7ere7.brazilsouth-01.azurewebsites.net/api/OrdemDeServico';
    ...
    async function deletarOS(id) {
        if (confirm(`Atenção: Tem certeza que deseja excluir a OS #${id}? Essa ação não tem volta.`)) {
            try {
                const resposta = await fetch(`https://api-gestao-manutencao-ecedhmdaffe7ere7.brazilsouth-01.azurewebsites.net/api/OrdemDeServico/${id}`, {
                    method: 'DELETE'
                });
